...
def create_detected_image_sidd(
    ...
    sidd_structure = create_sidd_structure(
        ...
        product_class='Detected Image', pixel_type='MONO{}I'.format(remap_function.bit_depth), remap_function=remap_function, version=version)  # joz jamming remap function in
    # set suggested name
